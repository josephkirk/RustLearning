...
impl Iterator for IRectIter {
    ...
    fn next(&mut self) -> Option<(i32, i32)> {
        let current_value = (
            self.rect.x_min + self.countx,
            self.rect.y_min + self.county,
        );    
...
mod tests {
    ...
    static RECT1: IRect = IRect { x_min: 0, y_min: 0, x_max: 5, y_max: 5};
    static RECT2: IRect = IRect { x_min: 4, y_min: 4, x_max: 7, y_max: 7};
    static RECT3: IRect = IRect { x_min: 1, y_min: 1, x_max: 3, y_max: 3};
    static RECT1_INTERSECT_RECT2 : IRect = IRect { x_min: 4, y_min: 4, x_max: 5, y_max: 5};
    #[test]
    ...
    fn test_rect_from_pos() {
        ...
        assert_eq!(IRect{x_min:10, y_min:10, x_max:20, y_max:20}, new_rect);
    }

    #[test]
    fn test_rect_fit_rect() {
        let mut test_rect = IRect {x_min: 0, y_min: 0, x_max: 100, y_max: 100};
    ...
    fn test_rect_iter_rect() {
        ...
        let rect = IRect{x_min:0, y_min:0, x_max:2, y_max:2};
